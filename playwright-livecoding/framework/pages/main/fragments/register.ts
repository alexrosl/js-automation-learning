...
class RegisterFragment extends BaseFragment{
    ...
    constructor(page, rootFragmentSelector = '.registration_form') {
        ...
        this.username = $element(this.page, '.registration_form .modal .form-group:nth-child(2) input', 'Username field')
        this.email = $element(this.page, '.registration_form .modal .form-group:nth-child(3) input', 'Email field')
        this.password = $element(this.page, '.registration_form .modal .form-group:nth-child(4) input', 'Password field')
